...
ActiveRecord::Schema.define(version: 20151118215151) do
  ...
  add_index "standups", ["channel_id"], name: "index_standups_on_channel_id", using: :btree
  ...
  add_foreign_key "standups", "channels"
